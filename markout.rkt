...
(module+ test
  (lets
    ...
    (begin
      ...
      (check-equal?
        table-0-widths
        (list (+ 7 9 padding) max-width
              (list 7 9)
              (list (cons 1 (- 17 9)) (cons 0 d0) (cons 1 (- d1 (- 17 9)))))
        )
      (check-equal?
        t0c-min
        (list 7 9)
